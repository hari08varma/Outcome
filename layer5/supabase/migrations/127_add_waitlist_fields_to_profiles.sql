-- ============================================================
-- LAYERINFINITE — Migration 127: Add Waitlist and Qualification Fields
-- ============================================================

-- 1. Add waitlist columns to user_profiles
...
-- 2. Update handle_new_user trigger to read the new fields from metadata
