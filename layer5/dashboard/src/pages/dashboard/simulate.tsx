        ...
        <div style={{ fontFamily: FONT_SANS, color: COLORS.textPrimary }}>
            <div className="w-full bg-[#111118] border border-[#1a1a24] rounded-xl px-5 py-3 mb-6 flex items-center justify-between">
                <div className="flex items-center gap-3">
                    <span className="text-[#b8ff00] text-lg">⚡</span>
                    <span className="text-[#a1a1aa] text-sm">
                        Simulate before you deploy - test action sequences against Layerinfinite's 3-tier model
                        <span className="text-white font-medium"> (Wilson CI {'->'} LightGBM {'->'} MCTS)</span>
                    </span>
                </div>
                <span className="text-[#00cc66] text-xs font-mono font-semibold bg-[#00cc66]/10 border border-[#00cc66]/30 rounded-full px-3 py-1">
                    ENGINE V4.2-STABLE
                </span>
            </div>
            <style>{`
