...
LI_REQUEST_TIMEOUT_SECONDS = parse_non_negative_float("LI_REQUEST_TIMEOUT_SECONDS", 10.0)
...
def run_mode(mode: str, count: int) -> list:
    ...
    for i in range(count):
        ...
        # Always apply throttling delay to keep RPS flat at ~60 per minute
        # even for baseline where li is None.
